...
const DeleteProductDrawer = ({ isOpen, onClose, product }) => {
    const handleDelete = () => {
        // Here you would send the delete request to the server
        console.log('Product deleted:', product?.kode_barang);
        onClose();
    };
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <div className="text-center">
                    ...
                    <p className="text-sm font-normal text-gray-600 dark:text-gray-400 mb-4">
                        {product?.kode_barang} - {product?.nama_barang}
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        This action cannot be undone. This will permanently delete the product and remove all data associated with it.
                    </p>
                </div>

...
const EditExpenseDrawer = ({ pengeluaran, isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await PengeluaranDataService.update(pengeluaran.id_pengeluaran, {
                tanggal,
                keterangan,
                jumlah: parseFloat(jumlah)
            });
            console.log('Pengeluaran berhasil diperbarui:', response.data);
            Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
            ...
            Swal.fire({
                icon: 'error',
                title: 'Gagal!',
                text: error.response?.data?.message || 'Terjadi kesalahan saat memperbarui pengeluaran.',
            });
        } finally {
            setLoading(false);
        }
...
EditExpenseDrawer.propTypes = {
    pengeluaran: PropTypes.shape({
        id_pengeluaran: PropTypes.number.isRequired,
